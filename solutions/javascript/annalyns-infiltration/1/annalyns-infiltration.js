...
export function canFreePrisoner(
  ...
  if (petDogIsPresent & (!archerIsAwake & (knightIsAwake  || !knightIsAwake) )  ) return true
  
  else if (  !archerIsAwake & !knightIsAwake  & prisonerIsAwake  ) return true 
  else if (!prisonerIsAwake) return false 
   else return false
}
